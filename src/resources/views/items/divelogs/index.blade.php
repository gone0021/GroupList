    ...
    <table class="table">
        <tr>
            ...
            <th>
                ...
                <a href="{{ url('divelogs/sort_title_a') }}?item_type=2">↓</a>
                <a href="{{ url('divelogs/sort_title_d') }}?item_type=2">↑</a>
            </th>
            ...
            <th>
                ...
                <a href="{{ url('divelogs/sort_date_a') }}?item_type=2">↓</a>
                <a href="{{ url('divelogs/sort_date_d') }}?item_type=2">↑</a>
            </th>
