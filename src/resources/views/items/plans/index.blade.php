    ...
    <table class="table">
        <tr>
            <th>
                ...
                <a href="{{ url('plans/sort_title_a') }}?item_type=3">↓</a>
                <a href="{{ url('plans/sort_title_d') }}?item_type=3">↑</a>
            </th>
            <th>
                <span class="mr-2">日付</span>
                <a href="{{ url('plans/sort_start_a') }}?item_type=3">↓</a>
                <a href="{{ url('plans/sort_start_d') }}?item_type=3">↑</a>
            </th>
